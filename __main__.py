...
print(f"\033[0;32m{stamp()} Prepared ARP packet (pkt 1):\033[0;2m{pack_str}\033[0m\n")

# Send the packet

SEND_PACKET(CONFIG["INT"], packet)

print(f"\033[0;32m{stamp()} Packet Sent \033[0m\n")
